...
function Banner(props: SectionProps<ReturnType<typeof loader>>) {
  ...
  return (
    <div class="flex flex-row w-full xl:mt-0 mt-1">
      <Picture preload class="xl:mx-[auto] xl:mt-4 xl:mb-0 mx-4 ">
        <Source
          src={image.mobile}
          width={328}
          height={232}
        ...
        />
        <img
          class="object-cover xl:object-fill rounded-lg w-full xl:h-[280px]"
          src={image.desktop}
          alt={image.alt ?? title}
        />
      </Picture>
