...
export default function NextButtonShelf({
  icon,
  iconHovered,
  sizeDesktop,
  sizeMobile,
  ...
  return (
    <>
      ...
      <div
        class="relative -right-[17px] -bottom-[138px] flex lg:hidden items-center justify-center z-10 col-start-3 row-start-2"
        onMouseEnter={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
        onTouchStart={handleMouseEnter}
        onTouchEnd={handleMouseLeave}
      >
        <Slider.NextButton class="absolute btn btn-circle bg-transparent border-none">
          {icon && (
            <Icon
              size={sizeMobile}
              id={idIcon.value || "BannerLeft"}
