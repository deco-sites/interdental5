...
const handleSetScope = () => {
  ...
  // @ts-expect-error
  window.vtexid.setScope("999628ce-e617-4273-b58e-87153e7d3b60");
  // deno-lint-ignore ban-ts-comment
  // @ts-expect-error
  window.vtexid.setScopeName("interdentaldeco");
};
  ...
  handleLoadCss(
    ...
    /*LOGIN ESTILIZADO:*/
          ...
          .vtexIdUI {
            ...
            border: 1.5px solid rgba(156, 160, 174, 0.30);
            top: 0 !important;
            left: 0 !important;
            right: 0;
            bottom: 0;
            ...
            .vtexIdUI input {
              ...
              border: 1.5px solid rgba(137, 141, 141, 0.60);
          ...
          h4.vtexIdUI-heading span::before {
            content: 'Entre com seu e-mail' !important;
          ...
          .vtexIdUI .vtexIdUI-send-email::before {
            content: 'Receber código de acesso' !important;
            font-size: 14px !important;
            position: absolute;
            left: 50%;
            font-weight: 700;
          ...
          button#loginWithUserAndPasswordBtn {
            background: #27239E !important; }
            
          button#loginWithUserAndPasswordBtn:hover {
            background: rgb(101 98 229)  !important; }
          
          button#loginWithAccessKeyBtn {
            background: white!important;
            color: #27239E!important;
            border: 1.25px solid #27239E !important; 
          display: flex;}

          button#loginWithAccessKeyBtn:hover {
              background: rgba(218, 222, 245, 0.60)!important;
           }
          ...
          .vtexIdUI-auth-code input {
            ...
            -webkit-border-radius: 8px !important;
            border-radius: 8px !important;
            border-color: rgba(137, 141, 141, 0.60) !important;
